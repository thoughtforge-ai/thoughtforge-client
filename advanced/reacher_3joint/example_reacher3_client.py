...
gym.register(
    id='reacher_3joint-v0',
    entry_point='advanced.reacher_3joint.reacher_3joint_env:Reacher3JointEnv',
...
class ExampleReacher3Session(BaseThoughtForgeClientSession):
    ...
    def sim_started_notification(self):
        ...
        print("Initializing reacher_3joint-v0...", end='')
        self.env = gym.make('reacher_3joint-v0')
    ...
    def update(self, motor_dict):
        ...
        motor_value_2 = motor_dict['motor_value_2'][0]
        
        # step openAI gym env and get updated observation
        env_step_result = self.env.step([motor_value_0, motor_value_1, motor_value_2])
